...
class ArticleProposalSimpleView(FormView):
    template_name = 'collaborate/article_proposal_simple.html'
    form_class = ArticleProposalSimpleForm
    success_url = reverse_lazy('article-proposal-thanks')

    def get_context_data(self, **kwargs):
        context = super(ArticleProposalSimpleView, self).get_context_data(**kwargs)
        fields = list(context['form'])
        context['part1'] = fields[:4]
        context['part2'] = fields[4:5]
        context['part3'] = fields[5:]
    ...
    def form_valid(self, form):
        ...
        return super(ArticleProposalSimpleView, self).form_valid(form)
