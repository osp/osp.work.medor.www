...
CKEDITOR.plugins.add( 'sidebar', {
    ...
    init: function( editor ) {
        ...
        editor.widgets.add( 'sidebar', {
            ...
            //allowedContent: 'blockquote; p; em; footer',

            // Minimum HTML which is required by this widget to work.
            requiredContent: 'aside(sidebar)',
            ...
            upcast: function( element ) {
                ...
                return element.name == 'aside' && element.hasClass( 'sidebar' );
            }
        } );
    }
} );
