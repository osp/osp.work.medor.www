...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'extraAllowedContent': 'h1 abbr figure figcaption footer small dl dt dd; aside(exergue,making-of); div[class] p(chapeau,intro-medor,question,auteur,fin,debut); ol(footnotes); img[data-*]; video[controls,src]; span(lettrine,print-only); iframe[src,width,height,frameborder,webkitallowfullscreen,mozallowfullscreen,allowfullscreen]',
