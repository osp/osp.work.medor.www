...
class Command(BaseCommand):
    help = 'Sends a second reminder to the cooperators for the 2015 AG'
    ...
    def handle(self, *args, **options):
        ...
        for group in mygrouper(10, emails):
            ...
            messages = []
            for email in group:
                subject = "Candidatures et inscription à l'Assemblée Générale Médor 2015"
                message = render_to_string('subscribe/cooperation-ag2015-reminder-second.txt', {})
