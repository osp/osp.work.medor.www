...
$(function() {
    ...
    */
    ...
    var contentOut = TweenMax.to("#cover-content", 0.000001, {left: "-1000px"});
    var detailIn = TweenMax.to("#cover-detail", 0.000001, {left: "0px"});
    var detailOut = TweenMax.to("#cover-detail", 0.000001, {left: "-1000px"});
    var coopIn = TweenMax.to("#cover-coop", 0.000001, {left: "0px"});
    var coopOut = TweenMax.to("#cover-coop", 0.000001, {left: "-1000px"});
    var budgetIn = TweenMax.to("#cover-budget", 0.000001, {left: "0px"});
    var budgetOut = TweenMax.to("#cover-budget", 0.000001, {left: "-1000px"});
